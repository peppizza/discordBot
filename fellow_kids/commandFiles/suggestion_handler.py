...
class SuggestionHandler(commands.Cog):
    ...
    async def on_message(self, message):
        if message.channel.id in suggestions:
            ...
            if catagory.id == CATEGORY_OPENSUGGESTIONS and not sender.has_role(ROLE_ADMINISTRATOR) and not sender.has_role(ROLE_BOTS) and not sender.id in self.bannedusers:
